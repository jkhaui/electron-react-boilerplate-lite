Electron React Boilerplate *Lite*

A much less opinionated, minimalistic version of https://github.com/electron
-react-boilerplate/electron-react-boilerplate

Does NOT contain:
- Flow
- Redux
- React Router
- ESLint or any opinionated code linter

Does contain:
- Latest versions of React & React-DOM
- [TODO: Add TypeScript]

Use the typical commands to setup:
> npm install
>
> npm run dev
